...
IB_DESIGNABLE
@interface WLUnitField : UITextField
...
/**
 设置单元格背景颜色，默认为nil。
 */
@property (null_resettable, nonatomic, strong) IBInspectable UIColor *unitColor;

/**
 设置文本颜色，默认为黑色。
 */
@property (null_resettable, nonatomic, strong) IBInspectable UIColor *unitTextColor;

@property (null_resettable, nonatomic, strong) IBInspectable UIColor *unitTintColor;
